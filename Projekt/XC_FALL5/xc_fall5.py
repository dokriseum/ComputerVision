...
# Erweiterte Data Augmentation Einstellungen
train_datagen = ImageDataGenerator(
    rescale=1./255,                    # Normalisieren der Pixelwerte
    samplewise_center=True,            # Setzt den Mittelwert jedes Samples auf 0
    samplewise_std_normalization=True, # Skaliert jedes Sample auf Einheitsvarianz
    rotation_range=30,                 # Rotation bis zu 30 Grad zufällig
    width_shift_range=0.15,            # Horizontalverschiebung um bis zu 15%
    height_shift_range=0.15,           # Vertikalverschiebung um bis zu 15%
    shear_range=0.15,                  # Scherintensität bis zu 15%
    zoom_range=0.5,                    # Zoom zwischen 50% (Verkleinern) bis 150% (Vergrößern)
    channel_shift_range=20,            # Zufällige Kanalverschiebungen um 20 Intensitätsstufen
    horizontal_flip=True,              # Horizontales Flippen erlauben
    vertical_flip=False,               # Vertikales Flippen ausschließen
    fill_mode='wrap',                  # Füllmodus auf 'wrap' für das Umhüllen der Pixel
    brightness_range=[0.2, 1.8],       # Helligkeitsanpassungen im Bereich von 0.2 bis 1.8
